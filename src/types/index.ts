...
export interface MonsterStatus {
    id: string;
    userId: string;
    bigFive: BigFiveStats;
    element: MonsterElement;
    currentForm: EvolutionStage;
    totalXp: number;
    unlockedSkills: string[];
    darksideWarnings: string[];
}
...
export type MonsterElement = 'fire' | 'water' | 'wind' | 'earth' | 'light' | 'dark';

export type EvolutionStage = 'wisp' | 'ember' | 'ignite' | 'blaze' | 'inferno' | 'phoenix';
...
export interface ActionLog {
    ...
    actionType: string;
    lifeArea: LifeArea;
    statChanges: Partial<BigFiveStats>;
    rewardUsed?: string;
    loggedAt: Date;
}

export type ActionLevel = 1 | 2 | 3 | 4 | 5;
...
export type SkillCategory = 'defense' | 'offense' | 'harmony';
